...
CH_TXS=1000 CH_THREADING="sequential" ./run.sh $CH_MACHINE-Parity-instantseal parity
...
CH_TXS=3000 CH_THREADING="sequential" ./run.sh $CH_MACHINE-Parity-aura parity
